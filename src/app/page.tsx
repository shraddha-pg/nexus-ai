...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f5f2] text-zinc-800 font-sans">
      ...
      {/* Nav */}
      <nav className="border-b border-zinc-200 px-8 py-4 flex items-center justify-between sticky top-0 z-40 bg-[#f7f5f2]/90 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-zinc-400 font-mono ml-2">CRM</span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-zinc-800 mb-1">Lead Pipeline</h1>
